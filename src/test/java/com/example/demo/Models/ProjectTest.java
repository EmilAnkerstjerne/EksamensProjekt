...
class ProjectTest {
    ...
    //TOBIAS
    @Test
    void calculateHoursWeekEmployeeNeededTest() {
        String pattern = "dd/MM/yyyy";
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
        Date startdate = null;
        Date deadline = null;
        ...
        int result = 20;
        Assertions.assertEquals(result,p1.calculateHoursWeekEmployeeNeeded());
    }

    //TOBIAS
    @Test
    void getTotalSubprojectsTime() {
        Project p1 = new Project(1,"Test projekt",1, null,null,
                0,0,0,false,0);
        ...
        Subtask st1 = new Subtask(1,1,"test subtask1",20);
        Subtask st2 = new Subtask(2,1,"test subtask1",30);
        t1.addSubtask(st1);
        t1.addSubtask(st2);

        int result = 50;
        Assertions.assertEquals(result,p1.getTotalSubprojectsTime());
